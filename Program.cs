namespace Labyrintian
{
    internal class Program
    {
        ...
        Item stick = new Item("Stick"); // Teaser content 
        MapItem map = new MapItem("Landscape Map");
        #endregion Items
        #region locations
        ...
        Location EndgameLocation = new Location("Nirvhalla", "It is self explanatory Nirvana and valhalla");
        #endregion locations
        ...
        void Run(string[] args)
        {
            ...
            bool isEnemyTrapped = false;
            while (true)
            {
                handlePlayerTurn(player);
                if (player.CurrentLocation == EndgameLocation)
                {
                    Console.WriteLine("You Have ascended to Nirvhalla");
                        break;
                }
                ...
                else
                {
                    ...
                    } else if (player.CurrentLocation.Name == enemy.CurrentLocation.Name && player.IsHiding == false)
                    {
            ...
            void handleEnemyMovement(Enemy enemy)
            {
                ...
                Location enemyCurrentLocation = enemy.CurrentLocation;
                do
                {
                    ConnectedLocationIndex = rndLocation.Next(enemy.CurrentLocation.ConnectedLocations.Count);
                    enemyCurrentLocation = enemy.CurrentLocation.ConnectedLocations[ConnectedLocationIndex];
                }
                while (enemyCurrentLocation == EndgameLocation);
                Console.Write(" There is a killer looking for you, The killer's current location is.\n ");
                Console.WriteLine(enemy.CurrentLocation.Name);
                enemy.CurrentLocation = enemyCurrentLocation;
            }
            ...
            {
                map.Castle = castle;
                map.NewWorld = EndgameLocation;
                map.LocationToConnectTo = desert;
